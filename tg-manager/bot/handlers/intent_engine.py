...
_PRESET_DESCRIPTIONS: dict[str, str] = {
    ...
    "strike": "Открыть массовые жалобы для ручной проверки и легитимных обращений",
...
async def _show_intent_main(
    ...
    text = (
        "🎯 <b>Навигатор целей</b>\n"
        "<i>Опиши результат, а Infragram соберёт план и откроет нужный инструмент.</i>\n\n"
        + "\n".join(status_lines)
