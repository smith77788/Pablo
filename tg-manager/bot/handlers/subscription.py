...
PLAN_DETAILED_FEATURES: dict[str, list[str]] = {
    ...
    "starter": [
        "🤖 До 10 ботов",
        "✅ Всё из FREE +",
        "🏷 CRM и теги (сегментация пользователей)",
        "🤖 Автоматизация (правила и триггеры)",
        "🔗 Цепочки сообщений (воронки/sequences)",
        "🔗 Диплинки с детальной аналитикой",
        "📈 SEO-анализ профиля бота",
        "👥 Экспорт аудитории (CSV)",
        "🔍 Парсер аудитории из каналов/групп",
    ...
    "pro": [
        ...
        "🌍 Мультигео (настройки по языку/локации)",
        "📢 Сетевые рассылки (по нескольким ботам)",
        "📊 Аналитика и рейтинги сети ботов",
        "🌐 Global Presence",
    ...
    "enterprise": [
        ...
        "🧬 Swarm — умный роутинг и распределение нагрузки",
        "🌐 Кластеры ботов и управление сетью",
        "📢 Сетевая рассылка v2 (дедупликация, сегментация)",
        "🤖 AI-ассистент для анализа и оптимизации",
        "⚔️ Strike Module — скидка 50% ($125 вместо $250)",
        "⚖️ Балансировка нагрузки и веса роутинга",
        "📊 Полная аналитика и неограниченный экспорт",
...
async def _build_menu_text_and_kb(pool: asyncpg.Pool, user_id: int):
    ...
    text = (
        ...
        f"<i>CRM, воронки, диплинки, SEO, парсер, трекер позиций, 1 аккаунт</i>\n\n"
        f"🚀 <b>PRO</b> — $25/мес · 30 ботов\n"
        f"<i>Фабрики каналов/групп, массовые операции, A/B тесты, аналитика, 3 аккаунта</i>\n\n"
        f"👑 <b>ENTERPRISE</b> — $69/мес · ∞ без лимитов\n"
        f"⭐ <i>ЛУЧШИЙ ВЫБОР — всё включено</i>\n"
        f"<i>∞ ботов + аккаунтов, DM-кампании, AI, Swarm, Strike -50%</i>\n"
