...
🟡 **Авто-реоптимизация при падении позиции** — если `position_history`
фиксирует просадку по ключу, авто-предложить/применить новую комбинацию
ключей (есть данные о просадке в `search_change_events`, нет авто-реакции).
