...
ОСТАЛОСЬ (10) — дорожная карта: group_announce,
bulk_dm_adhoc, bulk_post_chans, mass_report (массовые действия), bulk_bot_edit,
bulk_edit_channels, bulk_update_profile (массовое редактирование),
channel_import_all, group_import_all (импорт), gift_transfer.
