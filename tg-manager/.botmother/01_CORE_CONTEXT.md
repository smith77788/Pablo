...
- Telegram-native ecosystem management platform
- Universal Telegram Action Engine
- Mass creation system
...
- quick actions
- global search
- repeat/retry buttons

Mini Apps or web UI are optional only for:
- huge tables
- complex charts
- topology maps
- advanced analytics
...
The core product must not depend on opening a browser.
