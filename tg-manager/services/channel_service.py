...
СТАТУС: НЕ ПОДКЛЮЧЁН (проверено 2026-07-27). Статистика канала из
`operation_log`. Экрана-карточки канала, куда её встроить, в боте нет —
подключать вместе с таким экраном.
"""
