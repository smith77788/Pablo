...
- ⚠️ ПОКРЫТИЕ — САМОЕ ВАЖНОЕ: пройди по тексту и дай синонимы почти к КАЖДОМУ
  значимому слову — глаголам, существительным, прилагательным, наречиям и
  оборотам. НЕ должно оставаться подряд больше 2 слов без синонимов. Если между
  твоими записями остаётся длинный кусок текста без замен — добавь записи для
  слов из этого куска.
- Обороты (2-4 слова) тоже бери в "orig" целиком, если у них есть хороший синоним.
- НЕ перекрывай orig-подстроки между собой.
- Если к слову совсем нет 2+ живых синонимов — пропусти его (но таких должно быть
  мало: предлоги, союзы, имена собственные).
