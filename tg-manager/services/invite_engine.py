...
СТАТУС: НЕ ПОДКЛЮЧЁН (проверено 2026-07-27). Раздача ротируемых
инвайт-ссылок. Продукт приглашает иначе — `InviteToChannelRequest` напрямую
(`mass_inviter_engine`), то есть сценарий «выдать человеку ссылку» не
реализован. Это ширина, а не глубина: подключать вместе со сценарием, а не ради
самого подключения.
"""
