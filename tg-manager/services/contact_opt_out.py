...
def _compare_key(value: str) -> str:
    ...
    'ivan' (из normalize_target) с '@Ivan' (из аудитории) тихо не совпало бы,
    и opt-out переставал бы работать именно для тех username'ов, чей регистр
    в исходных данных отличается от того, как его ввёл оператор."""
    s = str(value)
