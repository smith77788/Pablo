# CLAUDE.md — BotMother OS: Главный ориентир системы (v3.4)
...
## 9. СХЕМА БД (60+ таблиц, v45 schema)
...
### ✅ ВСЕ КРИТИЧЕСКИЕ ПРОБЕЛЫ ЗАКРЫТЫ (r12)
...
## 16. СЛЕДУЮЩИЕ ПРИОРИТЕТЫ (r14 → r15)
...
### 🟡 Средний приоритет (r15)

5. **Import Center** — CSV import для bulk операций
   - Массовый импорт аккаунтов из файла
   - CSV import для списка городов в Global Presence

6. **Drift Detection** — мониторинг изменений
   - Отслеживание изменений username/title/about в каналах
...
8. Telegram Mini App: веб-дашборд для таблиц/графиков
9. Approval workflows: подтверждение перед критическими bulk-операциями
10. RBAC / Multi-user workspaces
...
_Последнее обновление: 2026-05-30 (r14)_
_Следующий build-номер: r15_
