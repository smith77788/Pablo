...
const CB_DATA = {
  ...
  ADM_ANALYTICS: 'adm_analytics',
  ADM_ORDERS_TODAY: 'adm_orders_today',
  ADM_ORDERS_WEEK: 'adm_orders_week',
  ADM_ORD_SEARCH: 'adm_ord_search',
  ADM_SEARCH_ORDER: 'adm_search_order',
  ADM_BULK_NEW_TO_REVIEW: 'adm_bulk_new_to_review',
  ADM_RUN_ORGANISM: 'adm_run_organism',
  ADM_FIX_ORGANISM: 'adm_fix_organism',
  AI_MATCH: 'ai_match',
