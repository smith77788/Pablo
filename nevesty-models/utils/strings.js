...
const RU = {
  ...
  // ─── FAQ fallbacks ────────────────────────────────────────────────────────
  FAQ_EMPTY:         '📭 FAQ пока пуст. Скоро добавим!',
  FAQ_HEADER:        '❓ *Частые вопросы*\n\nВыберите интересующий вопрос:',

  // ─── Review strings ───────────────────────────────────────────────────────
  REVIEW_THANKS:     '⭐ Спасибо за ваш отзыв! Он будет опубликован после проверки.',
  REVIEW_TOO_SHORT:  '❌ Отзыв слишком короткий. Минимум 10 символов.',
  REVIEW_SAVED:      (id) => `✅ Отзыв #${id} сохранён.`,

  // ─── Search strings ───────────────────────────────────────────────────────
  SEARCH_NO_RESULTS: '🔍 По вашим критериям ничего не найдено\\. Попробуйте другие фильтры\\.',
  SEARCH_HEADER:     '🔍 *Поиск моделей*\n\nВыберите фильтр:',

  // ─── Profile strings ──────────────────────────────────────────────────────
  PROFILE_HEADER:    '👤 *Ваш профиль*',
  PROFILE_SAVED:     '✅ Данные профиля обновлены!',
};
